...
namespace cs31
{
    ...
    {
        if (mTurnCount < 5) return GAMEOUTCOME::GAMENOTOVER;
        else if (mHuman.getRoundsWon() > mComputer.getRoundsWon()) return GAMEOUTCOME::HUMANWONGAME;
        else if (mComputer.getRoundsWon() > mHuman.getRoundsWon()) return GAMEOUTCOME::COMPUTERWONGAME;
        else return GAMEOUTCOME::TIEDGAME;
    }
